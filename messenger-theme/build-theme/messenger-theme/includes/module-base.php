 ...
 * @subpackage MessengerThemeModules
 */
abstract class Module_Base {
	...
	public static function is_active(): bool {
		 ...
		 */
		return apply_filters( 'messenger-plus-theme/modules/' . static::get_name() . '/is-active', true );
	}
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Something went wrong.', 'messenger-theme' ), '0.0.1' ); // @codeCoverageIgnore
	}
